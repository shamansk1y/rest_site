    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('number_of_people_1', models.IntegerField(choices=[(1, 'people 1'), (2, 'people 2'), (3, 'people 3'), (4, 'people 4'), (5, 'people 5'), (6, 'people 6')])),
                ('message_1', models.TextField(blank=True, max_length=250)),
